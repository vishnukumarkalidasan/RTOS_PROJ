...
//TaskSet 2 from HW5
  vSchedulerPeriodicTaskCreate(testFunc1, "T1", (configMINIMAL_STACK_SIZE), NULL, 0, &xHandle1, pdMS_TO_TICKS(0), pdMS_TO_TICKS(2000), pdMS_TO_TICKS(200), pdMS_TO_TICKS(1000));
  vSchedulerPeriodicTaskCreate(testFunc2, "T2", (configMINIMAL_STACK_SIZE), NULL, 0, &xHandle2, pdMS_TO_TICKS(50), pdMS_TO_TICKS(2000), pdMS_TO_TICKS(300), pdMS_TO_TICKS(1500));
  vSchedulerPeriodicTaskCreate(testFunc3, "T3", (configMINIMAL_STACK_SIZE), NULL, 0, &xHandle3, pdMS_TO_TICKS(100), pdMS_TO_TICKS(3000), pdMS_TO_TICKS(250), pdMS_TO_TICKS(2500));
  vSchedulerPeriodicTaskCreate(testFunc4, "T4", (configMINIMAL_STACK_SIZE), NULL, 0, &xHandle4, pdMS_TO_TICKS(200), pdMS_TO_TICKS(2500), pdMS_TO_TICKS(550), pdMS_TO_TICKS(1500));
